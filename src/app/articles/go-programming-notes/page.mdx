...
### SHA256 Checksum
- To check that what was received is what was intended. shasum -a 256 path/to/file 24325uib3654356rhrh897r8h78rthrthr
...
func (c count) String() string {
    return fmt.Sprint("This is the number ", strconv.Itoa(int(c))) // strconv.ParseInt(a,64)
}
