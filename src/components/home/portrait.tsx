...
import portrait from '@/components/home/portrait.png'
  ...
  return (
    <div className="order-1 col-span-12 flex border-x border-gray-30 px-4 pt-4 dark:border-gray-500 xs:px-8 xs:pt-8 md:order-2 md:col-span-6 md:border-l-0 md:border-r md:pb-8 min-[896px]:col-span-5 xl:order-2 xl:col-span-4">
      ...
      <motion.div
        ...
        className="relative flex h-[500px] w-[355px] rounded-2xl border-t border-gray-50/20 bg-gray-1000 bg-cover bg-center bg-no-repeat p-2 brightness-125 dark:brightness-100"
